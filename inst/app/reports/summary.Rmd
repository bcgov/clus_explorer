...
```
Scenario `r params$baseline_scenario` has been selected as the baseline, with "Future importance" factor set to `r risk`. Charts and table below show the values of baseline scenario. The facet variables are Growing Stock (m_gs), Volume Harvested (vol_h), and individual herd names.
