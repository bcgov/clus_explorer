...
Table and charts below show how other selected scenarios compare to the baseline scenario. Dimensions in those multi-dimensional plots are individual scenarios, Growing Stock (m_gs), Volume Harvested (vol_h), and individual herd names.
...
```{r summary_charts, fig.height=3.5, dpi=300}
ggradar::ggradar(
  params$radar_list, 
  base.size = 5,
